...
import java.util.*; 
/**
 * 처음에는 dfs 로 풀고, 인자로 계속 새로운 String 문자열을 만들어서 전달했었다. 그게 ㅁ메모리 초과의 원인이었음 
 * String 객체는 거기에 더하지 않고, 매번 새로운 객체를 만들기 때문이다. 
 * 
 * 그러니까 탐색의 방법을 bfs로 바꿔서 푸는 게 훨씬 효율적인 것임 
 */
public class Main_bj_2479_경로찾기 {
	static int N, K; 
